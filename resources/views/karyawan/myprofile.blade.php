                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="settings">
                                <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="cuti_dadakan">Sisa Cuti Tahunan</label>
                                            <input type="text" class="form-control" value="{{ auth()->user()->cuti_dadakan }}" disabled>
                                        </div>
                                        <div class="col">
                                            <label for="cuti_bersama">Sisa Cuti Melahirkan</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="cuti_diluar_tanggungan">Sisa Cuti Keluarga Meninggal</label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label for="cuti_khusus">Sisa Ibadah</label>
                                            <input type="text" disabled class="form-control" value="{{ auth()->user()->cuti_khusus }}">
                                        </div>
                                        <div class="col">
                                            <label for="cuti_melahirkan">Sisa Izin Sakit</label>
