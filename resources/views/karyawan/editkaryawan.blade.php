                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="settings">
                                <form method="post" action="{{ url('/pegawai/proses-edit/'.$karyawan->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="cuti_dadakan">Cuti Tahunan</label>
                                        ...
                                        <div class="col">
                                            <label for="cuti_bersama">Cuti Melahirkan</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            <label for="cuti_diluar_tanggungan">Cuti Keluarga Meninggal</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="cuti_khusus">Cuti Ibadah</label>
                                        ...
                                        <div class="col">
                                            <label for="cuti_melahirkan">Izin Sakit</label>
