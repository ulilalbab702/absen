                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="tableprintrekap" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>Nama Pegawai</th>
                                <th>Total Cuti Tahunan</th>
                                <th>Total Cuti Melahirkan</th>
                                <th>Total Cuti Menikah</th>
                                <th>Total Cuti Keluarga Meninggal</th>
                                <th>Total Cuti Ibadah</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        echo $du->Cuti->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])->where('nama_cuti', 'Cuti Tahunan')->where('status_cuti', 'Diterima')->count() . " x";
                                    @endphp
                                </td>
                                <td>
                                    @php
                                ...
                                <td>
                                    @php
                                        echo $du->Cuti->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])->where('nama_cuti', 'Cuti Keluarga Meninggal')->where('status_cuti', 'Diterima')->count() . " x";
                                    @endphp
                                </td>
                                <td>
                                    @php
                                        echo $du->Cuti->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])->where('nama_cuti', 'Cuti Ibadah')->where('status_cuti', 'Diterima')->count() . " x";
                                    @endphp
                                </td>
                                <td>
                                    @php
                                        echo $du->Cuti->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])->where('nama_cuti', 'Izin Sakit')->where('status_cuti', 'Diterima')->count() . " x";
                                    @endphp
                                </td>
                                <td>
                                    @php
