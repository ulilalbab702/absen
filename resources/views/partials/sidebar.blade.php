<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    @endif
        <img src="{{ url('assets/img/logo2.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">SMART Presensi</span>
    </a>
