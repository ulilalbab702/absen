                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                @php
                                    ...
                                    [
                                        'nama' => 'Cuti Tahunan',
                                        'nama_cuti' => 'Cuti Tahunan ('.$cuti_dadakan.')'
                                    ],
                                    [
                                        'nama' => 'Cuti Melahirkan',
                                        'nama_cuti' => 'Cuti Melahirkan ('.$cuti_bersama.')'
                                    ],
                                    [
                                        'nama' => 'Cuti Menikah',
                                    ...
                                    [
                                        ...
                                        'nama_cuti' => 'Cuti Keluarga Meninggal ('.$cuti_diluar_tanggungan.')'
                                    ],
                                    [
                                        'nama' => 'Cuti Ibadah',
                                        'nama_cuti' => 'Cuti Ibadah ('.$cuti_khusus.')'
                                    ],
                                    [
                                        'nama' => 'Izin Sakit',
                                        'nama_cuti' => 'Izin Sakit ('.$cuti_melahirkan.')'
                                    ],
                                    [
                                        'nama' => 'Izin Telat',
